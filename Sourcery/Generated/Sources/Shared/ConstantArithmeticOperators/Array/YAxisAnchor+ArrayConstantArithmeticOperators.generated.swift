...
@discardableResult
public func .* (lhs: LayoutConstant, rhs: YAxisAnchors ) -> YAxisAnchorExpressions {
...
@discardableResult
public func .* (lhs: LayoutConstant, rhs: YAxisAnchorExpressions) -> YAxisAnchorExpressions {
    return rhs .* lhs
}
