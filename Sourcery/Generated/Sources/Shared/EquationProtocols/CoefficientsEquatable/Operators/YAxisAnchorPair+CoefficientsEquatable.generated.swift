...
// MARK: YAxisAnchorPair <=> YAxisAnchorPair.RelativeLayoutConstantTuple

// MARK: - Equal

@discardableResult
public func .= (lhs: YAxisAnchorPair, rhs: YAxisAnchorPair.RelativeLayoutConstantTuple) -> YAxisAnchorPair.Solution {
    return lhs.equal(to: rhs)
}
...
// MARK: YAxisAnchorPair Array <=> YAxisAnchorPair.RelativeLayoutConstantTuple
