...
/*
    func testViewArrayLeadingLessThanOrEqualToLeadingPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .leading, .lessThanOrEqual, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayLeadingEqualToLeadingPlusConstantDividedByConstant() {
        let constraints = viewArray.leadingAnchor .= (relatedView.leading + 10) / 2
        constraints.assert(viewArray, .leading, .equal, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayLeadingGreaterThanOrEqualToLeadingPlusConstantDividedByConstant() {
        let constraints = viewArray.leadingAnchor ≥ (relatedView.leading + 10) / 2
        constraints.assert(viewArray, .leading, .greaterThanOrEqual, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayLeadingLessThanOrEqualToCenterXPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .leading, .lessThanOrEqual, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayLeadingEqualToCenterXPlusConstantDividedByConstant() {
        let constraints = viewArray.leadingAnchor .= (relatedView.centerX + 10) / 2
        constraints.assert(viewArray, .leading, .equal, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayLeadingGreaterThanOrEqualToCenterXPlusConstantDividedByConstant() {
        let constraints = viewArray.leadingAnchor ≥ (relatedView.centerX + 10) / 2
        constraints.assert(viewArray, .leading, .greaterThanOrEqual, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayLeadingLessThanOrEqualToTrailingPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .leading, .lessThanOrEqual, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayLeadingEqualToTrailingPlusConstantDividedByConstant() {
        let constraints = viewArray.leadingAnchor .= (relatedView.trailing + 10) / 2
        constraints.assert(viewArray, .leading, .equal, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayLeadingGreaterThanOrEqualToTrailingPlusConstantDividedByConstant() {
        let constraints = viewArray.leadingAnchor ≥ (relatedView.trailing + 10) / 2
        constraints.assert(viewArray, .leading, .greaterThanOrEqual, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayCenterXLessThanOrEqualToLeadingPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .centerX, .lessThanOrEqual, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayCenterXEqualToLeadingPlusConstantDividedByConstant() {
        let constraints = viewArray.centerXAnchor .= (relatedView.leading + 10) / 2
        constraints.assert(viewArray, .centerX, .equal, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayCenterXGreaterThanOrEqualToLeadingPlusConstantDividedByConstant() {
        let constraints = viewArray.centerXAnchor ≥ (relatedView.leading + 10) / 2
        constraints.assert(viewArray, .centerX, .greaterThanOrEqual, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayCenterXLessThanOrEqualToCenterXPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .centerX, .lessThanOrEqual, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayCenterXEqualToCenterXPlusConstantDividedByConstant() {
        let constraints = viewArray.centerXAnchor .= (relatedView.centerX + 10) / 2
        constraints.assert(viewArray, .centerX, .equal, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayCenterXGreaterThanOrEqualToCenterXPlusConstantDividedByConstant() {
        let constraints = viewArray.centerXAnchor ≥ (relatedView.centerX + 10) / 2
        constraints.assert(viewArray, .centerX, .greaterThanOrEqual, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayCenterXLessThanOrEqualToTrailingPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .centerX, .lessThanOrEqual, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayCenterXEqualToTrailingPlusConstantDividedByConstant() {
        let constraints = viewArray.centerXAnchor .= (relatedView.trailing + 10) / 2
        constraints.assert(viewArray, .centerX, .equal, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayCenterXGreaterThanOrEqualToTrailingPlusConstantDividedByConstant() {
        let constraints = viewArray.centerXAnchor ≥ (relatedView.trailing + 10) / 2
        constraints.assert(viewArray, .centerX, .greaterThanOrEqual, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayTrailingLessThanOrEqualToLeadingPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .trailing, .lessThanOrEqual, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayTrailingEqualToLeadingPlusConstantDividedByConstant() {
        let constraints = viewArray.trailingAnchor .= (relatedView.leading + 10) / 2
        constraints.assert(viewArray, .trailing, .equal, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayTrailingGreaterThanOrEqualToLeadingPlusConstantDividedByConstant() {
        let constraints = viewArray.trailingAnchor ≥ (relatedView.leading + 10) / 2
        constraints.assert(viewArray, .trailing, .greaterThanOrEqual, relatedView, .leading, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayTrailingLessThanOrEqualToCenterXPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .trailing, .lessThanOrEqual, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayTrailingEqualToCenterXPlusConstantDividedByConstant() {
        let constraints = viewArray.trailingAnchor .= (relatedView.centerX + 10) / 2
        constraints.assert(viewArray, .trailing, .equal, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayTrailingGreaterThanOrEqualToCenterXPlusConstantDividedByConstant() {
        let constraints = viewArray.trailingAnchor ≥ (relatedView.centerX + 10) / 2
        constraints.assert(viewArray, .trailing, .greaterThanOrEqual, relatedView, .centerX, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayTrailingLessThanOrEqualToTrailingPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .trailing, .lessThanOrEqual, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayTrailingEqualToTrailingPlusConstantDividedByConstant() {
        let constraints = viewArray.trailingAnchor .= (relatedView.trailing + 10) / 2
        constraints.assert(viewArray, .trailing, .equal, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayTrailingGreaterThanOrEqualToTrailingPlusConstantDividedByConstant() {
        let constraints = viewArray.trailingAnchor ≥ (relatedView.trailing + 10) / 2
        constraints.assert(viewArray, .trailing, .greaterThanOrEqual, relatedView, .trailing, constant: 10, multiplier: 1 / 2)
    }
*/
// sourcery:end
}
