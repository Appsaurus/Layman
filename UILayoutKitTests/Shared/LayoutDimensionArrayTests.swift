...
/*
    func testViewArrayWidthLessThanOrEqualToWidthPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .width, .lessThanOrEqual, relatedView, .width, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayWidthEqualToWidthPlusConstantDividedByConstant() {
        let constraints = viewArray.widthAnchor .= (relatedView.width + 10) / 2
        constraints.assert(viewArray, .width, .equal, relatedView, .width, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayWidthGreaterThanOrEqualToWidthPlusConstantDividedByConstant() {
        let constraints = viewArray.widthAnchor ≥ (relatedView.width + 10) / 2
        constraints.assert(viewArray, .width, .greaterThanOrEqual, relatedView, .width, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayWidthLessThanOrEqualToHeightPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .width, .lessThanOrEqual, relatedView, .height, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayWidthEqualToHeightPlusConstantDividedByConstant() {
        let constraints = viewArray.widthAnchor .= (relatedView.height + 10) / 2
        constraints.assert(viewArray, .width, .equal, relatedView, .height, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayWidthGreaterThanOrEqualToHeightPlusConstantDividedByConstant() {
        let constraints = viewArray.widthAnchor ≥ (relatedView.height + 10) / 2
        constraints.assert(viewArray, .width, .greaterThanOrEqual, relatedView, .height, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayHeightLessThanOrEqualToWidthPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .height, .lessThanOrEqual, relatedView, .width, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayHeightEqualToWidthPlusConstantDividedByConstant() {
        let constraints = viewArray.heightAnchor .= (relatedView.width + 10) / 2
        constraints.assert(viewArray, .height, .equal, relatedView, .width, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayHeightGreaterThanOrEqualToWidthPlusConstantDividedByConstant() {
        let constraints = viewArray.heightAnchor ≥ (relatedView.width + 10) / 2
        constraints.assert(viewArray, .height, .greaterThanOrEqual, relatedView, .width, constant: 10, multiplier: 1 / 2)
    }
*/
...
/*
    func testViewArrayHeightLessThanOrEqualToHeightPlusConstantDividedByConstant() {
        ...
        constraints.assert(viewArray, .height, .lessThanOrEqual, relatedView, .height, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: Equal
...
/*
    func testViewArrayHeightEqualToHeightPlusConstantDividedByConstant() {
        let constraints = viewArray.heightAnchor .= (relatedView.height + 10) / 2
        constraints.assert(viewArray, .height, .equal, relatedView, .height, constant: 10, multiplier: 1 / 2)
    }
*/
    // MARK: GreaterThanOrEqual
...
/*
    func testViewArrayHeightGreaterThanOrEqualToHeightPlusConstantDividedByConstant() {
        let constraints = viewArray.heightAnchor ≥ (relatedView.height + 10) / 2
        constraints.assert(viewArray, .height, .greaterThanOrEqual, relatedView, .height, constant: 10, multiplier: 1 / 2)
    }
*/
// sourcery:end
}
