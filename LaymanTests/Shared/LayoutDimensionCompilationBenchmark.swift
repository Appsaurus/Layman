...
class LayoutDimensionCompilationBenchmark: LaymanTestCase {
   /*
...
*/
    ...
    let relatedView3 = View3()
    let relatedView2 = View2()
    func genericView2() {

        view1.equal(to: stackView)
        stackView.equal(to: view1.edges)
        view1.equal(to: relatedView3)
        relatedView3 .= view1.centerXY
        stackView .= view1.edges.plus(10)
        view1.equal(to: relatedView2)
        view1.equal(to: view2)
        relatedView2.inset(from: view1)
        view1.leading.equal(to: view2.leading.plus(10))
        stackView.inset(from: view1.edges.plus(10))
        view1.equal(to: relatedView2)
        view1 .= relatedView2
        view1 .= relatedView2
        view1 .= relatedView2
